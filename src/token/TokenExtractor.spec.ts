...
describe("TokenExtractor", () => {
  ...
  describe("extractToken", () => {
    ...
    describe("DateLiteral", () => {
      it("should extract date literal what represent to 'YYYY'", () => {
        const query = `"2023" AND title == "Hello, World!"`;
        const result = extractor.extractToken(query);
        expect(result).toEqual<TokenExtractResult>({
          token: {
      ...
      it("should extract date literal what represent to 'YYYY-MM'", () => {
        const query = `"2023-01" AND title == "Hello, World!"`;
        const result = extractor.extractToken(query);
        expect(result).toEqual<TokenExtractResult>({
          token: {
            type: TokenType.DateLiteral,
      ...
      it("should extract date literal what represent to 'YYYY-MM-DD'", () => {
        const query = `"2023-01-21" AND title == "Hello, World!"`;
        const result = extractor.extractToken(query);
        expect(result).toEqual<TokenExtractResult>({
          token: {
            type: TokenType.DateLiteral,
      ...
      it("should extract date literal what represent to 'YYYY-MM-DDThh:mm:ss'", () => {
        const query = `"2023-01-21T12:34:56" AND title == "Hello, World!"`;
        const result = extractor.extractToken(query);
        expect(result).toEqual<TokenExtractResult>({
          token: {
            type: TokenType.DateLiteral,
            value: "2023-01-21T12:34:56",
          },
          nextRemainQuery: ` AND title == "Hello, World!"`,
        });
      });

      it("should extract date literal what represent to 'YYYY-MM-DDThh:mm:ss.sss'", () => {
        const query = `"2023-01-21T12:34:56.789" AND title == "Hello, World!"`;
        const result = extractor.extractToken(query);
        expect(result).toEqual<TokenExtractResult>({
          token: {
            type: TokenType.DateLiteral,
            value: "2023-01-21T12:34:56.789",
          },
          nextRemainQuery: ` AND title == "Hello, World!"`,
        });
      });

      it("should extract date literal what represent to 'YYYY-MM-DDThh:mm:ss.sssZ'", () => {
        const query = `"2023-01-21T12:34:56.789Z" AND title == "Hello, World!"`;
        const result = extractor.extractToken(query);
        expect(result).toEqual<TokenExtractResult>({
          token: {
            type: TokenType.DateLiteral,
            value: "2023-01-21T12:34:56.789Z",
          },
          nextRemainQuery: ` AND title == "Hello, World!"`,
        });
      });

      it("should extract date literal what represent to 'YYYY-MM-DDThh:mm:ss.sss+hh:mm'", () => {
        const query = `"2023-01-21T12:34:56.789+09:00" AND title == "Hello, World!"`;
        const result = extractor.extractToken(query);
        expect(result).toEqual<TokenExtractResult>({
          token: {
            type: TokenType.DateLiteral,
            value: "2023-01-21T12:34:56.789+09:00",
          },
          nextRemainQuery: ` AND title == "Hello, World!"`,
        });
      });
